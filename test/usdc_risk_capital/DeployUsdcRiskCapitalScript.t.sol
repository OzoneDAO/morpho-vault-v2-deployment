...
import {DeployUsdcRiskCapital} from "../../script/usdc_risk_capital/DeployUsdcRiskCapital.s.sol";
...
/**
 * @title DeployUsdcRiskCapitalScriptTest
 * @notice Tests for DeployUsdcRiskCapital deployment script
 * @dev Extends BaseVaultTest for common tests, adds USDC-specific tests
 */
contract DeployUsdcRiskCapitalScriptTest is BaseVaultTest {
    using SafeERC20 for IERC20;
    DeployUsdcRiskCapital public deployScript;
    DeployUsdcRiskCapital.DeploymentResult public result;
    ...
    function setUp() public override {
        super.setUp();
        deployScript = new DeployUsdcRiskCapital();
    }

    function _deployVault() internal override {
        deal(Constants.USDC, deployer, 10e6);
    ...
    function testOracleReturnsValidPrice() public {
        ...
        // Scale = 10^(36 + 6 - 18) = 10^24. stUSDS ~$1.05 USDC
    ...
    function testOracleFeedConfiguration() public {
        ...
        assertEq(oracle.QUOTE_FEED_1(), Constants.CHAINLINK_USDC_USD, "Quote feed 1 should be USDC/USD");
    ...
    function testMarketParams() public {
        ...
        assertEq(params.loanToken, Constants.USDC, "Loan token should be USDC");
        ...
        assertEq(params.lltv, Constants.LLTV_STUSDS, "LLTV should be 86%");
    ...
    function testVaultOperations() public {
        ...
        deal(Constants.USDC, user, depositAmount);
