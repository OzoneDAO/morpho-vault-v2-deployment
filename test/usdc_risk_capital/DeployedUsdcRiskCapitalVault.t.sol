...
/**
 * @title DeployedUsdcRiskCapitalVaultTest
 * @notice Tests against already-deployed USDC Risk Capital vault on Tenderly or mainnet fork
 * @dev Set VAULT_ADDRESS env var to test a specific deployed vault
 */
contract DeployedUsdcRiskCapitalVaultTest is BaseDeployedVaultTest {
